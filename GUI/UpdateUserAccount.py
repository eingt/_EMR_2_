...
background_img = PhotoImage(file = f"UpdateUserAccount BG.png")
...
entry1_img = PhotoImage(file = f"TextBox4.png")
...
entry2_img = PhotoImage(file = f"TextBox4.png")
...
entry3_img = PhotoImage(file = f"TextBox4.png")
